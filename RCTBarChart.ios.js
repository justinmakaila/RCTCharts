		...
		*/
		xAxisLabelPosition: PropTypes.number,
	  	...
	  	*/
	  	...
	  	/**
			The position of the labels on the y-axis
	  	*/
	  	yAxisLabelPosition: PropTypes.number,

	  	/**
			Whether the y-axis should draw gridlines
	  	*/
	  	yAxisDrawGridlinesEnabled: PropTypes.bool,

	  	/**
			The font used for the y-axis.
	  	*/
	  	yAxisFont: PropTypes.string,
